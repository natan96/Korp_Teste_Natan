...
- Create Angular project with ng: `ng new korp_teste_natan.client --defaults --skip-install --skip-git `.
...
- Create project file (`korp_teste_natan.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `korp_teste_natan.client.esproj`).
